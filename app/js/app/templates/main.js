  ...
  //     <span class="help-block"> We'll show you results with your exact specifications, and
  //     then make some guesses on your behalf. This ensures you don't miss some useful similar
  //     search results.</span>
  //   </form>
  ...
  // <script type="template-x-handlebars" id="template-infowindow">
  //   <div class="row">
  ...
  // <script type="template-x-handlebars" id="template-successful-submission">
  //   <h1>SUCCESS</h1>
  ...
  // <script type="template-x-handlebars" id="template-upload-error">
  //   <h1>Uh Oh...</h1>
  ...
  // <script type="template-x-handlebars" id="template-no-results">
